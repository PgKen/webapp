  ...
  return (
    <div className="box-privacy">
      ...
      <p>
        ...
        Conditions, which is accessible at Devpersoft unless otherwise defined
        in this Privacy Policy.
      </p>
      <p>
        <h2>Information Collection and Use</h2>
        Information Collection and Use For a better experience, while using our
        Service, I may require you to provide us with certain personally
        identifiable information. The information that I request will be
        retained on your device and is not collected by me in any way.
      </p>
      <p>
        <h2>Log Data</h2>I want to inform you that whenever you use my Service,
      ...
      <p>
        <h2>Security</h2>I value your trust in providing us your Personal
      ...
      <p>
        ...
        Policy I may update our Privacy Policy from time to time. Thus, you are
